...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btExit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/thoat.png"))); // NOI18N
    ...
    private void btLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btLoginActionPerformed
        ...
        if (taiKhoan.isEmpty() || matKhau.isEmpty()) {
            ...
            SinhVien sv = sinhviendata.dangNhap(taiKhoan, matKhau);
            Admin ad = admindata.dangNhap(taiKhoan, matKhau);
            try {
                if (sv != null) {
                    FormSinhVien jkh = new FormSinhVien();
                    jkh.setVisible(true);
                    dispose();
                } else if (ad != null) {
